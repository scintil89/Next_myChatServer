...
namespace NLogicLib
{
	...
	public:
		...
		void NotifyWisperChat(const int sessionIndex, const char* pszUserID, const wchar_t* pszMsg, const int recvSessionIndex);
	...
	protected:
		...
		void SendToUser(const short packetId, const short dataSize, char* pData, const int recvUserindex = -1);
