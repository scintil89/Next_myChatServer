...
namespace NCommon
{
	...
	enum class ERROR_CODE : short
	{
		...
		LOBBY_WHISPER_CHAT_INVALID_DOMAIN = 268,
		LOBBY_WHISPER_CHAT_INVALID_LOBBY_INDEX = 269,
		LOBBY_WHISPER_CHAT_INVALID_ROOM_INDEX = 270,
		LOBBY_WHISPER_CHAT_INVALID_SEND_USER = 300,
		LOBBY_WHISPER_USER_DIFFERENT_DOMAIN = 301,
		...
		ROOM_USER_LIST_INVALID_DOMAIN			= 311,
		ROOM_USER_LIST_INVALID_LOBBY_INDEX		= 312,
		ROOM_USER_LIST_INVALID_START_USER_INDEX = 313,


		ROOM_GAME_USER_INVALID_MASTER = 330,
		ROOM_GAME_STATE = 331,
		ROOM_GAME_USER_COUNT = 330,
	};
}